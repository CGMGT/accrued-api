...
@Entity
@Table(name = "xx_balance_hist", schema = "", catalog = "")
public class XxBalanceHistEntity extends AbstractEntity {
    ...
    public boolean equals(Object o) {
        ...
        XxBalanceHistEntity that = (XxBalanceHistEntity) o;
        return Objects.equals(fctDt, that.fctDt) && Objects.equals(prdCd, that.prdCd) && Objects.equals(cmpnyCd, that.cmpnyCd) && Objects.equals(accntngAccntCd, that.accntngAccntCd) && Objects.equals(lclAccntCd, that.lclAccntCd) && Objects.equals(cstCntrCd, that.cstCntrCd) && Objects.equals(trrtryCd, that.trrtryCd) && Objects.equals(bsnssUntEbsCd, that.bsnssUntEbsCd) && Objects.equals(ctgryCd, that.ctgryCd) && Objects.equals(prdctCd, that.prdctCd) && Objects.equals(prjctCd, that.prjctCd) && Objects.equals(intrcmpnyCd, that.intrcmpnyCd) && Objects.equals(flwCd, that.flwCd) && Objects.equals(ftr1Cd, that.ftr1Cd) && Objects.equals(ftr2Cd, that.ftr2Cd) && Objects.equals(bgnBlncAmnt, that.bgnBlncAmnt) && Objects.equals(prdNtAmnt, that.prdNtAmnt) && Objects.equals(clsngBlncAmnt, that.clsngBlncAmnt) && Objects.equals(crrncyCd, that.crrncyCd) && Objects.equals(ldgrNm, that.ldgrNm) && Objects.equals(ldgrCtgryCd, that.ldgrCtgryCd) && Objects.equals(ppnDt, that.ppnDt) && Objects.equals(id, that.id) && Objects.equals(periodo, that.periodo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(fctDt, prdCd, cmpnyCd, accntngAccntCd, lclAccntCd, cstCntrCd, trrtryCd, bsnssUntEbsCd, ctgryCd, prdctCd, prjctCd, intrcmpnyCd, flwCd, ftr1Cd, ftr2Cd, bgnBlncAmnt, prdNtAmnt, clsngBlncAmnt, crrncyCd, ldgrNm, ldgrCtgryCd, ppnDt, id, periodo);
    }
