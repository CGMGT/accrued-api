...
@Entity
@Table(name = "accrued_historico", schema = "", catalog = "")
public class AccruedHistoricoEntity extends AbstractEntity {
    private Long id;
