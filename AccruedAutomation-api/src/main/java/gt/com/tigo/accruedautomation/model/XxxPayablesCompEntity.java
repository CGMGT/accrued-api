...
@Entity
@Table(name = "xxx_payables_comp", schema = "", catalog = "")
public class XxxPayablesCompEntity {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        XxxPayablesCompEntity that = (XxxPayablesCompEntity) o;
        return Objects.equals(company, that.company) &&
                Objects.equals(receiptCreationDate, that.receiptCreationDate) &&
                Objects.equals(invoiceCurrencyCode, that.invoiceCurrencyCode) &&
                Objects.equals(amount, that.amount) &&
                Objects.equals(invoiceNum, that.invoiceNum) &&
                Objects.equals(baseAmount, that.baseAmount) &&
                Objects.equals(quantityInvoiced, that.quantityInvoiced) &&
                Objects.equals(unitPrice, that.unitPrice) &&
                Objects.equals(accountingDate, that.accountingDate) &&
                Objects.equals(receiptNum, that.receiptNum) &&
                Objects.equals(lineNum, that.lineNum) &&
                Objects.equals(poLine, that.poLine) &&
                Objects.equals(shipmentLineStatusCode, that.shipmentLineStatusCode) &&
                Objects.equals(orgName, that.orgName) &&
                Objects.equals(operatingUnit, that.operatingUnit) &&
                Objects.equals(poNum, that.poNum) &&
                Objects.equals(vendorName, that.vendorName) &&
                Objects.equals(vendorSiteCode, that.vendorSiteCode) &&
                Objects.equals(lineTypeLookupCode, that.lineTypeLookupCode);
    }

    @Override
    public int hashCode() {
        return Objects.hash(company, receiptCreationDate, invoiceCurrencyCode, amount, invoiceNum, baseAmount, quantityInvoiced, unitPrice, accountingDate, receiptNum, lineNum, poLine, shipmentLineStatusCode, orgName, operatingUnit, poNum, vendorName, vendorSiteCode, lineTypeLookupCode);
    }
}
