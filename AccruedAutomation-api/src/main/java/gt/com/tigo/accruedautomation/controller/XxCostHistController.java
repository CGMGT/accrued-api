...
import gt.com.tigo.accruedautomation.service.XxCostHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/costmanagementhist")
public class XxCostHistController extends AbstractController<XxCostHistEntity, XxCostHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxCostHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxCostHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxCostHistEntity entity, Long requesterId) {
        return null;
    }
