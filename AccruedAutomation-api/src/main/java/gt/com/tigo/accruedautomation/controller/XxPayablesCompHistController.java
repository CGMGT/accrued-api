...
import gt.com.tigo.accruedautomation.service.XxPayablesCompHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/payablescomphist")
public class XxPayablesCompHistController extends AbstractController<XxPayablesCompHistEntity, XxPayablesCompHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxPayablesCompHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxPayablesCompHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxPayablesCompHistEntity entity, Long requesterId) {
        return null;
    }
