...
import gt.com.tigo.accruedautomation.service.VConsolidacionResumenService;
...
@CrossOrigin
@RestController
@RequestMapping("/accruedConsolidacionRes")
public class VConsolidacionResumenController extends AbstractController<VConsolidacionResumenEntity, VConsolidacionResumenService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VConsolidacionResumenController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(VConsolidacionResumenEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(VConsolidacionResumenEntity entity, Long requesterId) {
        return null;
    }
