...
@Entity
@Table(name = "xx_cash_managment_hist", schema = "", catalog = "")
public class XxCashManagmentHistEntity extends AbstractEntity {
    ...
    public boolean equals(Object o) {
        ...
        XxCashManagmentHistEntity that = (XxCashManagmentHistEntity) o;
        return Objects.equals(batchName, that.batchName) && Objects.equals(documentSequence, that.documentSequence) && Objects.equals(gjhPeriodName, that.gjhPeriodName) && Objects.equals(journalName, that.journalName) && Objects.equals(xhEventTypeCode, that.xhEventTypeCode) && Objects.equals(xhAeHeaderId, that.xhAeHeaderId) && Objects.equals(gjlJeLineNum, that.gjlJeLineNum) && Objects.equals(xlCurrencyCode, that.xlCurrencyCode) && Objects.equals(accountingLineCode, that.accountingLineCode) && Objects.equals(eventClassCode, that.eventClassCode) && Objects.equals(company, that.company) && Objects.equals(account, that.account) && Objects.equals(local, that.local) && Objects.equals(cc, that.cc) && Objects.equals(territory, that.territory) && Objects.equals(bu, that.bu) && Objects.equals(category, that.category) && Objects.equals(product, that.product) && Objects.equals(project, that.project) && Objects.equals(interco, that.interco) && Objects.equals(flow, that.flow) && Objects.equals(future1, that.future1) && Objects.equals(future2, that.future2) && Objects.equals(concatenatedSegments, that.concatenatedSegments) && Objects.equals(enteredDebits, that.enteredDebits) && Objects.equals(enteredCredits, that.enteredCredits) && Objects.equals(enteredNet, that.enteredNet) && Objects.equals(accountedCredits, that.accountedCredits) && Objects.equals(accountedDebits, that.accountedDebits) && Objects.equals(accountedNet, that.accountedNet) && Objects.equals(accountingDate, that.accountingDate) && Objects.equals(jeSource, that.jeSource) && Objects.equals(jeCategory, that.jeCategory) && Objects.equals(ledgerName, that.ledgerName) && Objects.equals(transactionDescription, that.transactionDescription) && Objects.equals(paymentCurrencyCode, that.paymentCurrencyCode) && Objects.equals(bankAccountName, that.bankAccountName) && Objects.equals(bankAccountNum, that.bankAccountNum) && Objects.equals(currencyCode, that.currencyCode) && Objects.equals(bankAccountDestination, that.bankAccountDestination) && Objects.equals(bankAccountNumDestination, that.bankAccountNumDestination) && Objects.equals(cashflowDirection, that.cashflowDirection) && Objects.equals(cashflowNumber, that.cashflowNumber) && Objects.equals(bankAccountStatementDate, that.bankAccountStatementDate) && Objects.equals(id, that.id) && Objects.equals(periodo, that.periodo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(batchName, documentSequence, gjhPeriodName, journalName, xhEventTypeCode, xhAeHeaderId, gjlJeLineNum, xlCurrencyCode, accountingLineCode, eventClassCode, company, account, local, cc, territory, bu, category, product, project, interco, flow, future1, future2, concatenatedSegments, enteredDebits, enteredCredits, enteredNet, accountedCredits, accountedDebits, accountedNet, accountingDate, jeSource, jeCategory, ledgerName, transactionDescription, paymentCurrencyCode, bankAccountName, bankAccountNum, currencyCode, bankAccountDestination, bankAccountNumDestination, cashflowDirection, cashflowNumber, bankAccountStatementDate, id, periodo);
    }
