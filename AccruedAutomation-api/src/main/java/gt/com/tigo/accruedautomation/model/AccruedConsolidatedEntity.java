...
@Entity
@Table(name = "accrued_consolidated", schema = "", catalog = "")
public class AccruedConsolidatedEntity extends AbstractEntity {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        AccruedConsolidatedEntity that = (AccruedConsolidatedEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, llave, modulo, compania, cuenta, local, flujo, cc, proyecto, po, recepcion, linea, numDocumento, proveedor, concepto, moneda, monto, montoGtq, tc, revaluacion, montoRevaluado, antiguedad, status, cambiarAEstado, justificacionProvision, adjuntarArchivo, fechaRecepcion, nombreRequester, requesterEmail, nombreCreator, creatorEmail, nombreJefeOwner, jefeDeOwner, antiguedadPeriodo, origen, cargo, abono, kpi, fechaIntegracion);
    }
