...
@Entity
@Table(name = "v_rep_accrued_consolidado_hist", schema = "", catalog = "")
public class VRepAccruedConsolidadoHistEntity extends AbstractEntity {
    private Long id;
