...
import gt.com.tigo.accruedautomation.service.XxJournalEntriesHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/journalentrieshist")
public class XxJournalEntriesHistController extends AbstractController<XxJournalEntriesHistEntity, XxJournalEntriesHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxJournalEntriesHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxJournalEntriesHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxJournalEntriesHistEntity entity, Long requesterId) {
        return null;
    }
