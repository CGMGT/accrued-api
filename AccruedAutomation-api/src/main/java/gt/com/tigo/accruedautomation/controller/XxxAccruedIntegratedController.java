...
import gt.com.tigo.accruedautomation.service.XxxAccruedIntegratedService;
...
@CrossOrigin
@RestController
@RequestMapping("/xxxaccruedintegrated")
public class XxxAccruedIntegratedController extends AbstractController<XxxAccruedIntegratedEntity, XxxAccruedIntegratedService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxxAccruedIntegratedController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxxAccruedIntegratedEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxxAccruedIntegratedEntity entity, Long requesterId) {
        return null;
    }
