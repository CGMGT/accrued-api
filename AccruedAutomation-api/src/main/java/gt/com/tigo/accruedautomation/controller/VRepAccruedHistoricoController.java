...
import gt.com.tigo.accruedautomation.service.VRepAccruedHistoricoService;
...
@CrossOrigin
@RestController
@RequestMapping("/repaccruedhistorico")
public class VRepAccruedHistoricoController extends AbstractController<VRepAccruedHistoricoEntity, VRepAccruedHistoricoService> {
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(VRepAccruedHistoricoEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(VRepAccruedHistoricoEntity entity, Long requesterId) {
        return null;
    }
    ...
    public ResponseEntity<ByteArrayResource> exportToCsv(@RequestBody DataTableRequestDto dataTableRequestDto) {
        ...
        try {
            ResourceDto resourceDto = super.service.exportCsv(dataTableRequestDto);
