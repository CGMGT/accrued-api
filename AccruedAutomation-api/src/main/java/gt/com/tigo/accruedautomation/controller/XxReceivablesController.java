...
import gt.com.tigo.accruedautomation.service.XxReceivablesHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/receivableshist")
public class XxReceivablesController extends AbstractController<XxReceivablesHistEntity, XxReceivablesHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxReceivablesController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxReceivablesHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxReceivablesHistEntity entity, Long requesterId) {
        return null;
    }
