...
@Entity
@Table(name = "xx_cost_hist", schema = "", catalog = "")
public class XxCostHistEntity extends AbstractEntity {
    ...
    public boolean equals(Object o) {
        ...
        XxCostHistEntity that = (XxCostHistEntity) o;
        return Objects.equals(batchName, that.batchName) && Objects.equals(documentSequence, that.documentSequence) && Objects.equals(gjhPeriodName, that.gjhPeriodName) && Objects.equals(journalName, that.journalName) && Objects.equals(jeCategory, that.jeCategory) && Objects.equals(xhEventTypeCode, that.xhEventTypeCode) && Objects.equals(xlCurrencyCode, that.xlCurrencyCode) && Objects.equals(company, that.company) && Objects.equals(account, that.account) && Objects.equals(local, that.local) && Objects.equals(cc, that.cc) && Objects.equals(territory, that.territory) && Objects.equals(bu, that.bu) && Objects.equals(category, that.category) && Objects.equals(product, that.product) && Objects.equals(project, that.project) && Objects.equals(interco, that.interco) && Objects.equals(flow, that.flow) && Objects.equals(future1, that.future1) && Objects.equals(future2, that.future2) && Objects.equals(concatenatedSegments, that.concatenatedSegments) && Objects.equals(enteredDebits, that.enteredDebits) && Objects.equals(enteredCredits, that.enteredCredits) && Objects.equals(enteredNet, that.enteredNet) && Objects.equals(accountedCredits, that.accountedCredits) && Objects.equals(accountedDebits, that.accountedDebits) && Objects.equals(accountedNet, that.accountedNet) && Objects.equals(accountingDate, that.accountingDate) && Objects.equals(jeSource, that.jeSource) && Objects.equals(poNumber, that.poNumber) && Objects.equals(receiptNumber, that.receiptNumber) && Objects.equals(documentDescription, that.documentDescription) && Objects.equals(documentDate, that.documentDate) && Objects.equals(partyName, that.partyName) && Objects.equals(exchangeRate, that.exchangeRate) && Objects.equals(sourceDocQuantity, that.sourceDocQuantity) && Objects.equals(item, that.item) && Objects.equals(itemDescription, that.itemDescription) && Objects.equals(ledgerName, that.ledgerName) && Objects.equals(comments, that.comments) && Objects.equals(poStatus, that.poStatus) && Objects.equals(poCurrencyCode, that.poCurrencyCode) && Objects.equals(combinacionContablePo, that.combinacionContablePo) && Objects.equals(poCompany, that.poCompany) && Objects.equals(poAccount, that.poAccount) && Objects.equals(poLocal, that.poLocal) && Objects.equals(poCc, that.poCc) && Objects.equals(poTerritory, that.poTerritory) && Objects.equals(poBu, that.poBu) && Objects.equals(poCategory, that.poCategory) && Objects.equals(poProduct, that.poProduct) && Objects.equals(poProject, that.poProject) && Objects.equals(poInterco, that.poInterco) && Objects.equals(poFlow, that.poFlow) && Objects.equals(poFuture1, that.poFuture1) && Objects.equals(poFuture2, that.poFuture2) && Objects.equals(fechaModificacionPo, that.fechaModificacionPo) && Objects.equals(prLineNum, that.prLineNum) && Objects.equals(uom, that.uom) && Objects.equals(quantity, that.quantity) && Objects.equals(unitCost, that.unitCost) && Objects.equals(requesterEmail, that.requesterEmail) && Objects.equals(requisitionNumber, that.requisitionNumber) && Objects.equals(description, that.description) && Objects.equals(reqStatus, that.reqStatus) && Objects.equals(requisitionType, that.requisitionType) && Objects.equals(creatorName, that.creatorName) && Objects.equals(creatorEmail, that.creatorEmail) && Objects.equals(transactionDate, that.transactionDate) && Objects.equals(transactionTypeName, that.transactionTypeName) && Objects.equals(transactionReference, that.transactionReference) && Objects.equals(transactionId, that.transactionId) && Objects.equals(organizationName, that.organizationName) && Objects.equals(id, that.id) && Objects.equals(periodo, that.periodo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(batchName, documentSequence, gjhPeriodName, journalName, jeCategory, xhEventTypeCode, xlCurrencyCode, company, account, local, cc, territory, bu, category, product, project, interco, flow, future1, future2, concatenatedSegments, enteredDebits, enteredCredits, enteredNet, accountedCredits, accountedDebits, accountedNet, accountingDate, jeSource, poNumber, receiptNumber, documentDescription, documentDate, partyName, exchangeRate, sourceDocQuantity, item, itemDescription, ledgerName, comments, poStatus, poCurrencyCode, combinacionContablePo, poCompany, poAccount, poLocal, poCc, poTerritory, poBu, poCategory, poProduct, poProject, poInterco, poFlow, poFuture1, poFuture2, fechaModificacionPo, prLineNum, uom, quantity, unitCost, requesterEmail, requisitionNumber, description, reqStatus, requisitionType, creatorName, creatorEmail, transactionDate, transactionTypeName, transactionReference, transactionId, organizationName, id, periodo);
    }
