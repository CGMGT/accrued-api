...
import gt.com.tigo.accruedautomation.service.XxCashManagementHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/cashmanagementhist")
public class XxCashManagementHistController extends AbstractController<XxCashManagmentHistEntity, XxCashManagementHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxCashManagementHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxCashManagmentHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxCashManagmentHistEntity entity, Long requesterId) {
        return null;
    }
