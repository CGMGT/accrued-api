...
@Entity
@Table(name = "xxx_journal_entries", schema = "", catalog = "")
public class XxxJournalEntriesEntity {
    private Long id;
    ...
    @Basic
    @Column(name = "dscrptn_gl", nullable = true, length = 500)
    ...
    @Basic
    @Column(name = "dscrptn_gh", nullable = true, length = 500)
    ...
    public boolean equals(Object o) {
        ...
        XxxJournalEntriesEntity that = (XxxJournalEntriesEntity) o;
        return Objects.equals(fctDt, that.fctDt) &&
                Objects.equals(ldgrNm, that.ldgrNm) &&
                Objects.equals(dcSqncVl, that.dcSqncVl) &&
                Objects.equals(ldgrId, that.ldgrId) &&
                Objects.equals(jrnlNmbr, that.jrnlNmbr) &&
                Objects.equals(lstUpdtDt, that.lstUpdtDt) &&
                Objects.equals(jeCtgry, that.jeCtgry) &&
                Objects.equals(jeSrc, that.jeSrc) &&
                Objects.equals(prdDd, that.prdDd) &&
                Objects.equals(nmDd, that.nmDd) &&
                Objects.equals(crrncyCd, that.crrncyCd) &&
                Objects.equals(sttsDd, that.sttsDd) &&
                Objects.equals(dtCrtd, that.dtCrtd) &&
                Objects.equals(actlFlg, that.actlFlg) &&
                Objects.equals(blncdJeFlg, that.blncdJeFlg) &&
                Objects.equals(jeBtchId, that.jeBtchId) &&
                Objects.equals(pstdDt, that.pstdDt) &&
                Objects.equals(dscrptnGl, that.dscrptnGl) &&
                Objects.equals(rnngTtlDr, that.rnngTtlDr) &&
                Objects.equals(rnngTtlCr, that.rnngTtlCr) &&
                Objects.equals(rnngTtlAccntdDr, that.rnngTtlAccntdDr) &&
                Objects.equals(rnngTtlAccntdCr, that.rnngTtlAccntdCr) &&
                Objects.equals(crtdBy, that.crtdBy) &&
                Objects.equals(lstUpdtdBy, that.lstUpdtdBy) &&
                Objects.equals(effctvDt, that.effctvDt) &&
                Objects.equals(jeLnNmbr, that.jeLnNmbr) &&
                Objects.equals(entrdDr, that.entrdDr) &&
                Objects.equals(entrdCr, that.entrdCr) &&
                Objects.equals(entrdNt, that.entrdNt) &&
                Objects.equals(accntdDr, that.accntdDr) &&
                Objects.equals(accntdCr, that.accntdCr) &&
                Objects.equals(accntdNt, that.accntdNt) &&
                Objects.equals(dscrptnGh, that.dscrptnGh) &&
                Objects.equals(cmpnyDd, that.cmpnyDd) &&
                Objects.equals(accntDd, that.accntDd) &&
                Objects.equals(lclDd, that.lclDd) &&
                Objects.equals(ccDd, that.ccDd) &&
                Objects.equals(trrtryDd, that.trrtryDd) &&
                Objects.equals(buDd, that.buDd) &&
                Objects.equals(ctgryDd, that.ctgryDd) &&
                Objects.equals(prdctDd, that.prdctDd) &&
                Objects.equals(prjctDd, that.prjctDd) &&
                Objects.equals(intrcDd, that.intrcDd) &&
                Objects.equals(flwDd, that.flwDd) &&
                Objects.equals(ftr1Dd, that.ftr1Dd) &&
                Objects.equals(ftr2Dd, that.ftr2Dd) &&
                Objects.equals(ppnDt, that.ppnDt) &&
                Objects.equals(source, that.source) &&
                Objects.equals(jrnalStdFlg, that.jrnalStdFlg);
    }

    @Override
    public int hashCode() {
        return Objects.hash(fctDt, ldgrNm, dcSqncVl, ldgrId, jrnlNmbr, lstUpdtDt, jeCtgry, jeSrc, prdDd, nmDd, crrncyCd, sttsDd, dtCrtd, actlFlg, blncdJeFlg, jeBtchId, pstdDt, dscrptnGl, rnngTtlDr, rnngTtlCr, rnngTtlAccntdDr, rnngTtlAccntdCr, crtdBy, lstUpdtdBy, effctvDt, jeLnNmbr, entrdDr, entrdCr, entrdNt, accntdDr, accntdCr, accntdNt, dscrptnGh, cmpnyDd, accntDd, lclDd, ccDd, trrtryDd, buDd, ctgryDd, prdctDd, prjctDd, intrcDd, flwDd, ftr1Dd, ftr2Dd, ppnDt, source, jrnalStdFlg);
    }
}
