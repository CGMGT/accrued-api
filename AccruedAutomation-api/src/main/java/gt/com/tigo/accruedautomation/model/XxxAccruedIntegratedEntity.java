...
@Entity
@Table(name = "xxx_accrued_integrated", schema = "", catalog = "")
public class XxxAccruedIntegratedEntity extends AbstractEntity {
    ...
    public XxxAccruedIntegratedEntity() {
        // not implemented
    }
    
    public XxxAccruedIntegratedEntity(AccruedIntegratedEntity accruedIntegratedEntity) {
        this.id = accruedIntegratedEntity.getId();
        this.llave = accruedIntegratedEntity.getLlave();
        this.modulo = accruedIntegratedEntity.getModulo();
        this.compania = accruedIntegratedEntity.getCompania();
        this.cuenta = accruedIntegratedEntity.getCuenta();
        this.local = accruedIntegratedEntity.getLocal();
        this.flujo = accruedIntegratedEntity.getFlujo();
        this.cc = accruedIntegratedEntity.getCc();
        this.proyecto = accruedIntegratedEntity.getProyecto();
        this.po = accruedIntegratedEntity.getPo();
        this.recepcion = accruedIntegratedEntity.getRecepcion();
        this.linea = accruedIntegratedEntity.getLinea();
        this.numDocumento = accruedIntegratedEntity.getNumDocumento();
        this.proveedor = accruedIntegratedEntity.getProveedor();
        this.concepto = accruedIntegratedEntity.getConcepto();
        this.moneda = accruedIntegratedEntity.getMoneda();
        this.monto = accruedIntegratedEntity.getMonto();
        this.montoGtq = accruedIntegratedEntity.getMontoGtq();
        this.tcHistorico = accruedIntegratedEntity.getTcHistorico();
        this.tcCierre = accruedIntegratedEntity.getTcCierre();
        this.revaluacion = accruedIntegratedEntity.getRevaluacion();
        this.montoRevaluado = accruedIntegratedEntity.getMontoRevaluado();
        this.antiguedad = accruedIntegratedEntity.getAntiguedad();
        this.status = accruedIntegratedEntity.getStatus();
        this.cambiarAEstado = accruedIntegratedEntity.getCambiarAEstado();
        this.justificacionProvision = accruedIntegratedEntity.getJustificacionProvision();
        this.adjuntarArchivo = accruedIntegratedEntity.getAdjuntarArchivo();
        this.fechaRecepcion = accruedIntegratedEntity.getFechaRecepcion();
        this.nombreRequester = accruedIntegratedEntity.getNombreRequester();
        this.requesterEmail = accruedIntegratedEntity.getRequesterEmail();
        this.nombreCreator = accruedIntegratedEntity.getNombreCreator();
        this.creatorEmail = accruedIntegratedEntity.getCreatorEmail();
        this.nombreJefeOwner = accruedIntegratedEntity.getNombreJefeOwner();
        this.jefeDeOwner = accruedIntegratedEntity.getJefeDeOwner();
        this.antiguedadPeriodo = accruedIntegratedEntity.getAntiguedadPeriodo();
        this.origen = accruedIntegratedEntity.getOrigen();
        this.cargo = accruedIntegratedEntity.getCargo();
        this.abono = accruedIntegratedEntity.getAbono();
        this.kpi = accruedIntegratedEntity.getKpi();
        this.fechaIntegracion = accruedIntegratedEntity.getFechaIntegracion();
        this.statusIntegracion = accruedIntegratedEntity.getStatusIntegracion();
        this.mayor1Anio = accruedIntegratedEntity.getMayor1Anio();
    }
    ...
    @Basic
    @Column(name = "status_integracion", nullable = true, length = 50)
    ...
    @Basic
    @Column(name = "mayor_1_anio", nullable = true, length = 150)
    ...
    public boolean equals(Object o) {
        ...
        XxxAccruedIntegratedEntity that = (XxxAccruedIntegratedEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, llave, modulo, compania, cuenta, local, flujo, cc, proyecto, po, recepcion, linea, numDocumento, proveedor, concepto, moneda, monto, montoGtq, tcHistorico, tcCierre, revaluacion, montoRevaluado, antiguedad, status, cambiarAEstado, justificacionProvision, adjuntarArchivo, fechaRecepcion, nombreRequester, requesterEmail, nombreCreator, creatorEmail, nombreJefeOwner, jefeDeOwner, antiguedadPeriodo, origen, cargo, abono, kpi, fechaIntegracion, statusIntegracion, mayor1Anio, comentarios);
    }
