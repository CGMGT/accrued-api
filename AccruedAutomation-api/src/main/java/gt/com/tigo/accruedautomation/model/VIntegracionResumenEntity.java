...
@Entity
@Table(name = "v_integracion_resumen", schema = "", catalog = "")
public class VIntegracionResumenEntity extends AbstractEntity {
    private Long id;
    ...
    @Basic
    @Column(name = "monto_revaluado", nullable = true, precision = 0)
    ...
    public boolean equals(Object o) {
        ...
        VIntegracionResumenEntity that = (VIntegracionResumenEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(compania, cuenta, montoRevaluado, montoBalance, diferencia);
    }
