...
import gt.com.tigo.accruedautomation.service.AccruedConsolidatedService;
...
@CrossOrigin
@RestController
@RequestMapping("/accruedconsolidated")
public class AccruedConsolidatedController extends AbstractController<AccruedConsolidatedEntity, AccruedConsolidatedService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AccruedConsolidatedController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(AccruedConsolidatedEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(AccruedConsolidatedEntity entity, Long requesterId) {
        return null;
    }
