...
import gt.com.tigo.accruedautomation.service.XxPurchaseOrderService;
...
@CrossOrigin
@RestController
@RequestMapping("/xxPurchaseOrder")
public class XxPurchaseOrderController extends AbstractController<XxPurchaseOrderEntity, XxPurchaseOrderService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxPurchaseOrderController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxPurchaseOrderEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxPurchaseOrderEntity entity, Long requesterId) {
        return null;
    }
