...
@Entity
@Table(name = "accrued_integrated", schema = "", catalog = "")
public class AccruedIntegratedEntity extends AbstractEntity {
    private Long id;
    ...
    public void setTcHistorico(Double tc) {
        this.tcHistorico = tc;
    }
