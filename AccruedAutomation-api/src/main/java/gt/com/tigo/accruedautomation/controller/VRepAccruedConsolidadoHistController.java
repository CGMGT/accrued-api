...
import gt.com.tigo.accruedautomation.service.VRepAccruedConsolidadoHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/repaccruedconsolidated")
public class VRepAccruedConsolidadoHistController extends AbstractController<VRepAccruedConsolidadoHistEntity, VRepAccruedConsolidadoHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VRepAccruedConsolidadoHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(VRepAccruedConsolidadoHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(VRepAccruedConsolidadoHistEntity entity, Long requesterId) {
        return null;
    }
