...
import gt.com.tigo.accruedautomation.service.XxPayablesHistService;
...
@CrossOrigin
@RestController
@RequestMapping("/payableshist")
public class XxPayablesHistController extends AbstractController<XxPayablesHistEntity, XxPayablesHistService> {

    private static final Logger LOGGER = LoggerFactory.getLogger(XxPayablesHistController.class);
    ...
    @Override
    public ResponseEntity<TigoResponseDto> create(XxPayablesHistEntity entity, Long requesterId) {
        return null;
    }

    @Override
    public ResponseEntity<TigoResponseDto> update(XxPayablesHistEntity entity, Long requesterId) {
        return null;
    }
